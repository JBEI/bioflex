package org.jbei.bio.sequence.alphabets
{
    ...
    * 
    */
    public class DNAAlphabetSingleton extends AbstractAlphabet
    {
        private static var _instance:DNAAlphabetSingleton = null;
        ...
        public function DNAAlphabetSingleton()
        {
            super();
            if (_instance) {
                throw new BioException("Can not call constructor on a singleton. Use instance instead");
            }
        }
        
        public static function get instance():DNAAlphabetSingleton 
        {
            if (_instance == null) {
                _instance = new DNAAlphabetSingleton();
            }    
